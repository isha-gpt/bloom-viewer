...
return {
	...
	_: {
		...
		nodes: [
			...
			__memo(() => import('./chunks/8-GgPeo-Gv.js')),
			__memo(() => import('./chunks/9-BOMd9Bsw.js'))
		],
		remotes: {
		...
		routes: [
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./chunks/_server.ts-nok_RpfZ.js'))
			},
			{
