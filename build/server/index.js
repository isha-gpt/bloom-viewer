...
import { r as render, e as experimental_async_ssr, i as is_passive_event } from './chunks/index2-nyuh1qwz.js';
...
async function get_hooks() {
  ...
  let init;
  ({ handle, handleFetch, handleError, handleValidationError, init } = await import('./chunks/hooks.server-o9p2NDp5.js'));
  let reroute;
  let transport;
  return {
    handle,
